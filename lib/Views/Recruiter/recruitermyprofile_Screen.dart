            ...
            body: Container(
              ...
              child: recruiterProfileModel == null ? Center(child: CircularProgressIndicator(),) : ListView(
                children: [
                     ...
                     InkWell(
                       ...
                       child: Row(
                         ...
                         Container(
                           ...
                           SizedBox(width: 8,),
                           Text("Employer", style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold, color: currentIndex == 1 ? primaryColor : greyColor1,)),
                         ],
                       ),
                     ),
                      InkWell(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 8,),
                            Text("Consultant", style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold, color: currentIndex == 2 ? primaryColor : greyColor1),),
                          ],
                        ),
                      )
                    ],
                  ...
                  //   ],
                  // ),
                  CustomTextFormField(label: 'Company Name', labelColor: greyColor,fieldcontroller: companyController,),
                  CustomTextFormField(label: 'Name', labelColor: greyColor,fieldcontroller: namecController,),
                  CustomTextFormField(label: 'Email', labelColor: greyColor,fieldcontroller: emailController,),
                  CustomTextFormField(label: 'Mobile', labelColor: greyColor,fieldcontroller: mobileController,),
                  CustomTextFormField(label: 'Location', labelColor: greyColor,fieldcontroller: locationController,),
                  CustomTextFormField(label: 'Address', labelColor: greyColor,fieldcontroller: addressController,),
                  CustomTextFormField(label: 'Website Address', labelColor: greyColor,fieldcontroller: websiteController,),
                  CustomTextFormField(label: 'Write A Short Desciption Of Your\nCompany Which Will Show In Your Profile*', labelColor: greyColor,maxLine: 3,fieldcontroller: descriptionController,),
                 // CustomDetailTextField(labelText: "Write A Short Desciption Of Your\nCompany Which Will Show In Your Profile*", maxLines: 4, labelColor: greyColor,),
                  ...
                  Align(
                    alignment: Alignment.center,
                    child: CustomTextButton(buttonText: "Update", onTap: (){
