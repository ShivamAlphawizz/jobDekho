   ...
   userType == null || userType == ""  ? Container(
      ...
      backgroundColor: primaryColor,
        appBar: AppBar(
          ...
          elevation: 0,
          backgroundColor: primaryColor,
          title: userType == "seeker" ? Text("Filter") : Text("Search Candidate"),
          centerTitle: true,
          actions: [
            Padding(
              ...
              child: ListView(
                  ...
                  InkWell(
                    ...
                    child: Container(
                      padding: EdgeInsets.only(left: 15),
                        ...
                        height: 45,
                        child: Text("Job Type",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 1 ? Colors.white: Colors.black),)),
                  ),
                  SizedBox(height: 5,),
                  InkWell(
                    onTap: (){
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Location",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 2 ? Colors.white: Colors.black),),
                    ),
                  ),
                  SizedBox(height: 5,),
                  InkWell(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Designation",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 3 ? Colors.white: Colors.black),),
                    ),
                  ),
                  SizedBox(height: 5,),
                  InkWell(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Qualification",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 4 ? Colors.white: Colors.black),),
                    ),
                  ),
                  SizedBox(height: 5,),
                  InkWell(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Experience",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 5 ? Colors.white: Colors.black),),
                    ),
                  ),
                  SizedBox(height: 5,),
                  InkWell(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Specializaion",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 6 ? Colors.white: Colors.black),),
                    ),
                  ),
                  SizedBox(height: 5,),
                userType == "seeker" ?  SizedBox.shrink() :  InkWell(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Skill",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 7 ? Colors.white: Colors.black),),
                    ),
                  ),
                  SizedBox(height: 5,),
                  userType == "seeker" ?  SizedBox.shrink() :  InkWell(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Job Role",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 8 ? Colors.white: Colors.black),),
                    ),
                  ),
                  SizedBox(height: 5,),
                  userType == "seeker" ?  SizedBox.shrink() :    InkWell(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Expected CTC",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 9 ? Colors.white: Colors.black),),
                    ),
                  ),
                  SizedBox(height: 5,),
                  userType == "seeker" ?  SizedBox.shrink() :    InkWell(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      child: Text("Notice Period",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600, color: currentIndex == 10 ? Colors.white: Colors.black),),
                    ),
                  ),
                ],
              ),
