    ...
    return SafeArea(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            backgroundColor: primaryColor,
            title: Text('Applied Jobs', style: TextStyle(color: whiteColor, fontSize: 18, fontWeight: FontWeight.bold),),
            centerTitle: true,
          ),
          body:  RefreshIndicator(
            ...
            child: Container(
              ...
              child: seekerAppliedJob == null ? Center(child: CircularProgressIndicator(),) : seekerAppliedJob!.data!.length == 0 ? Center(child: Text("No Jobs to see"),) : ListView.builder(
